...
export const translations: Resources = {
	ja: {
		...
		"project.back": "プロジェクト一覧へ",
		"projects.title": "プロジェクト一覧",
		"projects.intro":
			"個人で開発したゲーム・ツール・プラグインなどです。各カードから詳細ページへ進めます。",
		"articles.title": "記事一覧",
		"articles.intro":
			"技術記事は Zenn と note で公開しています。ここではタイトルと公開日の一覧です。本文は各リンク先でお読みください。",
	...
	en: {
		...
		"articles.intro":
			"Articles are published on Zenn and note. This page lists titles and dates; full text is on each platform.",
